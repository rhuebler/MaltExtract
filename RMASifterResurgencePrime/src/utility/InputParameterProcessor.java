...
public class InputParameterProcessor {
    ...
    {	FilenameFilter RMAFilter = new FilenameFilter() {
    	 ...
    	 CommandLine commandLine;
    	    ...
    	    Option option_Output = Option.builder("output").argName("outDir").hasArg().desc("Output Directory").build();
    	    Option option_Taxons = Option.builder("taxons").argName("tax").hasArg().desc("File with taxons to look up").build();
    	    
    	    // long flags
    	    Option option_Threads = Option.builder().longOpt("threads").argName("numThreads").hasArg().desc("Number of Cores to run on").build();		
    	    Option option_TopPercent = Option.builder().longOpt("top").argName("topPercent").hasArg().desc("Top Percent of Matches to Consider").build();
    	    Option option_Behaviour = Option.builder().longOpt("behaviour").argName("behave").hasArg().desc("Specify the behaviour for run eg ancient").build();
    	    ...
    	    try
    	    {
    	        ...
    	        {
    	            System.out.println("Taxons set to: ");
    	        ...
    	        {
    	            System.out.println("Behaviour set to: ");
